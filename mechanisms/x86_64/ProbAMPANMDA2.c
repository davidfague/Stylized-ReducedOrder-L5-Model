...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 7;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA2 /content/drive/MyDrive/Stylized-Cell-model/mechanisms/ProbAMPANMDA2.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ...
   g_AMPA = initW * .001 * ( B_AMPA - A_AMPA ) ;
   g_NMDA = initW * .001 * ( B_NMDA - A_NMDA ) * mggate ;
   i_AMPA = g_AMPA * ( v - e ) ;
   i_NMDA = g_NMDA * ( v - e ) ;
   i = i_AMPA + i_NMDA ;
   }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/content/drive/MyDrive/Stylized-Cell-model/mechanisms/ProbAMPANMDA2.mod";
static const char* nmodl_file_text = 
