...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 VecStim /content/drive/MyDrive/Stylized-Cell-model/mechanisms/vecevent.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/content/drive/MyDrive/Stylized-Cell-model/mechanisms/vecevent.mod";
static const char* nmodl_file_text = 
